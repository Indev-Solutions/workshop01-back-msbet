INSERT INTO bet_schema.bet (id, league_id, "match", match_date) VALUES(1, 1, 'Universitario vs Alianza', now()); 
INSERT INTO bet_schema.bet (id, league_id, "match", match_date) VALUES(2, 2, 'Barcelona vs Real Madrid', '2024-06-10 18:32:33.034');
